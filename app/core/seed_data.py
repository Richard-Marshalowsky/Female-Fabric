...
def seed_database(db: Session):
    ...
    products_data = [
        ...
        {
            "name": "Шовкова міді-спідниця А-силуету",
            "slug": "silk-midi-skirt-a-line",
            "sku": "FF-SK-007",
            "category_slug": "skirts",
            "price": 2750.0,
            "old_price": 3200.0,
            "description": "Елегантна спідниця міді косого крою зі струмуючого атласного шовку. Еластичний прихований пояс для максимального комфорту.",
            "details_json": json.dumps({"composition": "100% шовковий атлас", "fit": "А-силует", "season": "Всесезон", "care": "Ручне прання 30°C"}),
            "is_featured": True,
            "is_new": True,
            "images": [
        ...
        {
            "name": "Діловий брючний костюм-трійка Milano",
            "slug": "suit-three-piece-milano",
            "sku": "FF-ST-008",
            "category_slug": "suits",
            "price": 7900.0,
            "old_price": 9500.0,
            "description": "Комплект з приталеного жакета, жилета та прямих штанів зі стрілками. Преміальна італійська костюмна тканина.",
            "details_json": json.dumps({"composition": "70% вовна, 25% віскоза, 5% еластан", "fit": "Класичний приталений", "season": "Всесезон", "care": "Хімчистка"}),
            "is_featured": True,
            "is_new": False,
            "images": [
        ...
        {
            "name": "Тренч двобортний водонепроникний Classic Trench",
            "slug": "classic-trench-waterproof",
            "sku": "FF-OW-009",
            "category_slug": "outerwear",
            "price": 6800.0,
            "old_price": 7900.0,
            "description": "Класичний англійський тренч з щільної бавовняної тканини з водовідштовхувальним просоченням. Пояс із пряжкою.",
            "details_json": json.dumps({"composition": "100% органічна бавовна з просоченням", "fit": "Прямий крій", "season": "Весна/Осінь", "care": "Хімчистка"}),
            "is_featured": True,
            "is_new": True,
            "images": [
        ...
        {
            "name": "Шовкова хустка з авторським принтом Silk Garden",
            "slug": "silk-scarf-garden",
            "sku": "FF-AC-010",
            "category_slug": "accessories",
            "price": 1450.0,
            "old_price": None,
            "description": "Квадратна хустка 90x90 см з натурального шовку саржевого переплетення з ручним підшиванням краю роуль.",
            "details_json": json.dumps({"composition": "100% шовк твіл", "fit": "90x90 см", "season": "Всесезон", "care": "Делікатне ручне прання"}),
            "is_featured": False,
            "is_new": True,
            "images": [
        ...
        {
            "name": "Оверсайз сорочка з органічної бавовни Pure Linen",
            "slug": "oversize-cotton-shirt-pure",
            "sku": "FF-BL-011",
            "category_slug": "blouses",
            "price": 2200.0,
            "old_price": 2600.0,
            "description": "Подовжена вільна сорочка з натуральної бавовни. Ідеальна основа для сучасного багатошарового гардероба.",
            "details_json": json.dumps({"composition": "100% преміальна бавовна", "fit": "Вільний оверсайз", "season": "Всесезон", "care": "Машинне прання 40°C"}),
            "is_featured": False,
            "is_new": True,
            "images": [
                "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?w=1000&auto=format&fit=crop&q=75"
        ...
        {
            "name": "Кардиган великої в'язки Alpaca Cloud",
            "slug": "cardigan-alpaca-cloud",
            "sku": "FF-KN-012",
            "category_slug": "knitwear",
            "price": 3400.0,
            "old_price": 4100.0,
            "description": "Об'ємний м'який кардиган з вовни альпаки та мериноса. Рогові ґудзики та затишний теплий фасон.",
            "details_json": json.dumps({"composition": "60% альпака, 30% меринос, 10% поліамід", "fit": "Об'ємний", "season": "Осінь/Зима", "care": "Ручне прання в прохолодній воді"}),
            "is_featured": True,
            "is_new": False,
            "images": [
